...
df["Average Pace (Float)"] = df["Average Pace"].apply(pace_to_float)
...
dffPace = df[df["Average Pace (Float)"] < 20] # above 20min/mile is complete walks

# print(df.query("`Average Heart Rate` < 120"))
# print(df.query("`Average Pace` > 20"))
